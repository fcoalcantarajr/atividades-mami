...
void ret_bandeira(int cX, int cY, float mod) {
  fill(0,156,59);
  noStroke();
  rectMode(CENTER);
  rect(cX,cY,mod*20,mod*14);
}
void losango_bandeira(int cX, int cY, float mod) {
  fill(255,223,0);
  quad(cX,(cY-5.3*mod),(cX+8.3*mod),cY,cX,(cY+5.3*mod),(cX-8.3*mod),cY);
}
void circ_bandeira(int cX, int cY, float mod) {
  fill(0,39,118);
